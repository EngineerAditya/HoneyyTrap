...
> **Ground Truth Reference Document - DO NOT MODIFY**
> 
> This document contains the exact requirements from the GUVI Hackathon. All implementations must strictly adhere to these specifications.
...
## 8. Agent Output Format (Response)
...
**Deadline:** 05 Feb 2026, 11:59:00 PM

### Submission Form Fields:

1. **Deployed URL** - Your public API endpoint
...
1. Send official test inputs to your endpoint
2. Validate authentication using the API key
3. Check request handling and response structure
4. Evaluate the correctness and stability of your solution

### Evaluation Readiness Checklist

- [ ] API handles multiple requests reliably
- [ ] Correct JSON response format as defined
- [ ] Low latency and proper error handling
- [ ] Final callback to GUVI endpoint working

---

> **Note:** Only outcomes are evaluated. No code is reviewed.
